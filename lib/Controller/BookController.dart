...
class BookController extends GetxController {
  ...
  var allBooks = <BookModel>[].obs; // To store all books initially
  ...
  void getUserBook() async {
    try {
      ...
      errorMessage("Failed to fetch user books: $e");
    }
  }
  ...
  void searchBooks(String query) {
    ...
    if (query.isEmpty) {
      ...
      var searchedBooks = allBooks
          .where((book) =>
              book.title?.toLowerCase().contains(query.toLowerCase().trim()) ??
              false)
          .toList();
